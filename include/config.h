...
#define BRIGHTNESS_DIM 2            // ~1% brightness when inactive (was 13)
...
#define GMT_OFFSET_SEC 0            // Adjust for your timezone (e.g., -18000 for EST)
...
#define COLOR_NIGHT_ARC_COLD 0x4000      // Dark red
#define COLOR_NIGHT_ARC_WARM 0x8800      // Medium red
